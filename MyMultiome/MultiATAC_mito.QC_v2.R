...
datatoplot<-data.frame(Name=c("Raw","TotalMito","Mapped","MappedMito","Read_mito_Cell","Frag_mito_Cell"),N=c(ReadsCounts$V2[1],ReadsCounts$V2[2],ReadsCounts$V2[3],ReadsCounts$V2[4],sum(Cell.Mito.Reads$V3),sum(Cell.Mito.Reads$V2)))
