...
Options: --input or -i: uniqmapped.bam files generated by MultiomeATAC_mito.sh, REQUIRED.
     ...
     --script-dir or -sd  default = directory containing this script. The path to REDEEM-V/mitoConsensus/
...
@click.option('--ncores', '-c', default = 48, help='Number of cores to run the main job in parallel. default is 24')
@click.option('--files-per-core', '-f', default = 1, help='Number of files each core deals with sequentially, default is 2. If memory is limited. Set this number larger')
...
@click.option('--script-dir', '-sd', default=str(Path(__file__).resolve().parent), show_default=True, help='The path to REDEEM-V/mitoConsensus/')
